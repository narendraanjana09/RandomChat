...
import com.nsa.randomchat.databinding.FragmentChatsBinding
import com.nsa.randomchat.ui.home.adapters.MessageAdapter
...
class ChatsFragment : Fragment() {
   ...
   private val chatsList= arrayListOf<ChatsModel>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Analyitcs().log("chats_open","Chat Started or room created")
        ...
        roomViewModel.roomDeleted.observe(viewLifecycleOwner){
            if(it){
                Analyitcs().log("Room_Deleted","Room Deleted")
                cancelChat()
            }
        }
        ...
        binding.sendBtn.setOnClickListener {
            ...
            Analyitcs().log("Message_Sent","User Sent Message")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activity?.onBackPressedDispatcher?.addCallback(this,object : OnBackPressedCallback(true){
            override fun handleOnBackPressed() {
                binding.randomIcon.callOnClick()
            }
        })
    }
